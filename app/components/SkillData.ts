...
const _skills: Array<[string, string[], number, number]> = [
  ["Python", ["backend"], 4, 2],
  ["Ruby", ["backend"], 11, 2],
  ["JavaScript", ["frontend", "backend"], 12, 2],
  ["TypeScript", ["frontend", "backend"], 4, 2],
  ["React", ["frontend"], 6, 2],
  ["Rails", ["backend", "frontend"], 11, 2],
  ["Django", ["backend", "frontend"], 4, 2],
  ["Next.js", ["backend", "frontend"], 1, 1],
  ["C++", ["backend"], 2, 0],
  ["C#", ["backend"], 4, 2],
  ["Java", ["backend"], 1, 0],
  ["Node.js", ["backend"], 1, 0],
  ...
  ["GCP Sentiment Analysis", ["data"], 1, 0],
  ...
  ["Cursor", ["frontend", "backend"], 1, 0],
  ["Copilot", ["frontend", "backend"], 1, 0],
  ["Communication", ["management"], 12, 2],
  ["Estimation", ["management"], 12, 2],
  ["Project Management", ["management"], 10, 2],
